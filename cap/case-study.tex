\chapter{Case study: geostatistics on neolithic settlements in Tavoliere}
    ...
    \section{The GIS approach to statistics}
        ...
        \subsection{Saving and access data}
            ...
            Django enables the development of web-based products; this means that the whole set of functions described in the previous sections is easily accessible using a web browser (further details about the webGIS interface will be given in \fref{sec:webgis}).
